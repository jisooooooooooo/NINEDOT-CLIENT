...
import GoButton from '@/commoan/component/GoButton/GoButton';
...
const Todo = () => {
  ...
  useEffect(() => {
    ...
    const step = (timestamp: number) => {
      ...
      if (progress < 1) {import { useState } from 'react';
import { useNavigate } from 'react-router-dom';

import { FULL_TEXT, TYPING_DURATION, PLACEHOLDER_TEXT } from './constant/constants';import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
